...
def final_df():
    try:
        ...
        dt_Data_to_dashboard = pd.read_csv("temp/data_to_dashboard.csv")        
        dt_prediccion = pd.read_csv("temp/base_prediccion2.csv")
        ...
        print("fechas historicos")
        print(fechas_historico)
        print(type(fechas_historico))
        ...
        # print(fechas_nuevas_prediccion.to_csv("fechas_nuevas_prediccion.csv"))
